...
const String baseUrlHttp = 'http://127.0.0.1:8000';
const String urlWebSocket = 'ws://127.0.0.1:8000/ws/bar';
        ...
        child: Column(
          ...
          children: [
            ElevatedButton.icon(
              ...
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const TelaBarman()));
              },
            ),
            ...
            ElevatedButton.icon(
              ...
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const TelaCozinha()));
              },
            ),
          ],
        ),
